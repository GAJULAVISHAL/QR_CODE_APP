            ...
            {step === 1 ? (
                <div className="w-full max-w-md bg-white rounded-lg shadow-md p-4">
                    <div className="p-4">
                        ...
                        <p>Already have an account ? <Link to={"/login"} className='text-[#8B8B8D]'>Login</Link></p>
                    </div>
                ...
                <div className="w-full max-w-md bg-white rounded shadow-md">
                    ...
                    {/* Card Content */}
                    <div className="p-4">
                        <div className="flex items-start bg-green-50 border border-green-200 p-4 rounded">
                            {/* CheckCircle Icon */}
                            <svg
                            ...
                            <div className="ml-2">
                                ...
                                <p className="text-green-700">
                                    All your Passes and QR codes will be generated on this userId :  {' '}
