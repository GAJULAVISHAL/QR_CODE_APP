...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-white shadow-md mb-4 rounded-lg">
        ...
        <div className="flex justify-between items-center h-14">
          ...
          <div className="md:hidden">
            <button
              ...
              type="button"
              className="bg-gray-200 inline-flex items-center justify-center p-2 rounded-md text-gray-800 hover:text-white hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800"
